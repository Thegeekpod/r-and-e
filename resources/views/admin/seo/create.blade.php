...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div class="d-flex align-items-center gap-2">
        <i class="fa-solid fa-circle-plus fs-3" style="color: var(--primary-accent);"></i>
        <div>
            <h4 class="fw-bold m-0 text-dark">Add SEO Entry</h4>
            <p class="text-muted small m-0">Configure meta title, description, and header scripts for any page URL.</p>
        </div>
    </div>
